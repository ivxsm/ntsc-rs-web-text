...
const fontOptions: {id: TitleFontFamily, name: string}[] = [
    {id: 't-serif-light', name: 'Thmanya Serif Text Light'},
    {id: 't-serif-bold', name: 'Thmanya Serif Text Bold'},
    {id: 't-serif-black', name: 'Thmanya Serif Text Black'},
    {id: 't-display-light', name: 'Thmanya Serif Display Light'},
    {id: 't-display-bold', name: 'Thmanya Serif Display Bold'},
    {id: 't-display-black', name: 'Thmanya Serif Display Black'},
];
        ...
        <div className={style.titlePane}>
            <div className={style.titleSettings}>
                <div className={style.setting}>
                    <CheckboxToggle className={style.checkbox} label="Enable title overlay" checked={titleEnabled} />
                </div>
                <div className={style.setting}>
                    <SliderWithSpinBox
                        value={titleDuration}
                ...
                <div className={style.setting}>
                    <SliderWithSpinBox
                        ...
                        step={1}
                    />
                    <div className={style.settingLabel}>Text Size</div>
                </div>
                <div className={style.setting}>
